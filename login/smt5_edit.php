...
$nisn = $_SESSION['nisn'];
$nilaiw = mysql_query("SELECT * FROM bk.smt5 WHERE nisn = '$nisn'")or die(mysql_error());?>
...
<div class="content-wrapper">
		<div class="container-fluid">
			<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-12">
								<h1>Edit Nilai Semester 5</h1>
  <form method="post" action="proses/pro5.php" enctype="multipart/form-data">
