<!DOCTYPE html>
	...
	<h2>Tambah / Update Foto</h2>
	<br/>
	<h4 style="color:red;"><strong><td>Jangan menekan tombol POTONG & SIMPAN sebelum menyisipkan/input gambar ! (data tidak akan terkirim)</td></strong></h4>
	<br/>
	<hr>
			<div class="row">
				<div id="changePic" class="" style="display:allow">
	                <form id="cropimage" method="post" enctype="multipart/form-data" action="profile.php">
						<label>Upload Gambar (klik "Choose file")</label><input type="file" name="photoimg" id="photoimg" />
	            ...
	            <div class="modal-footer">
	                <button type="button" class="btn btn-default" onclick="window.history.back()">Batal & Kembali</button>
	                <button type="button" id="btn-crop" class="btn btn-primary">Potong & Simpan</button>
	            </div>
			</div>
		</div>
