	 ...
	 /*********************************************************************
	      ...
	      ***********************************************************************/
	 	 ...
	 	 function changeAvatar() {
	         ...
	         {
	         $actual_image_name = 'fotoku' .'_'.$userId .'.'.$ext;
	         $filePath = $path .'/'.$actual_image_name;
	         $tmp = $_FILES['photoimg']['tmp_name'];
					 $ipku = "UPDATE bio SET fotoku = '$actual_image_name' WHERE nisn = '$userId'";
	      ...
	      ***********************************************************************/
	      function saveAvatarTmp() {
	         ...
	         $t_width = 400; // Maximum thumbnail width
