...
$excel->getProperties()->setCreator('SMA Negeri 3 Bondowoso')
             ->setTitle("Rekap Nilai Semester 1")
             ->setSubject("Siswa");
...
$excel->getActiveSheet(0)->setTitle("SEMESTER 1");
$excel->setActiveSheetIndex(0);
// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Data Nilai Semester 1.xlsx"'); // Set nama file excel nya
