...
$excel->getProperties()->setCreator('SMA Negeri 3 Bondowoso')
             ->setTitle("Rekap Nilai Semester 4")
             ->setSubject("Siswa");
...
$excel->getActiveSheet(0)->setTitle("SEMESTER 4");
$excel->setActiveSheetIndex(0);
// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Data Nilai Semester 4.xlsx"'); // Set nama file excel nya
