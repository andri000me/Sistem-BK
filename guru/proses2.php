...
$excel->getProperties()->setCreator('SMA Negeri 3 Bondowoso')
             ->setTitle("Rekap Nilai Semester 2")
             ->setSubject("Siswa");
...
$excel->getActiveSheet(0)->setTitle("SEMESTER 2");
$excel->setActiveSheetIndex(0);
// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Data Nilai Semester 2.xlsx"'); // Set nama file excel nya
